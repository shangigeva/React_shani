...
const registerSchema = Joi.object({
  ...
  password: Joi.string()
    ...
    .messages({
      "string.pattern.base":
        "The password must contain at least one lowercase letter, one uppercase letter, one digit, and one special character (!@#$%^&*-). It should be at least 7 characters long.",
      "string.empty":
